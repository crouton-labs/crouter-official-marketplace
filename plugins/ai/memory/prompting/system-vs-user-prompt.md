...
At scale this is significant: a 10K token system prompt cached across 100 requests costs roughly 11% of what an uncached equivalent would. See [system-vs-user-prompt-reference.md → Caching Math](system-vs-user-prompt-reference.md) for the breakdown. See also [context-management](context-management.md) for comprehensive caching strategies.
...
For good/bad examples and API code, see [system-vs-user-prompt-reference.md](system-vs-user-prompt-reference.md).
