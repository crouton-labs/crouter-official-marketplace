...
short-form: Deep-dive companion to the prompting-effectively skill — worked examples and the full catalog the skill body points to.
system-prompt-visibility: none
file-read-visibility: none
---
# Prompt Architecture Reference

Detailed patterns and examples for structuring LLM prompts. This supplements the overview in [prompting-effectively.md](prompting-effectively.md).
