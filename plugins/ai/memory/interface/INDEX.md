...
- **agent-facing/** — cli-design (CLIs an agent drives), tool-design (structured tool-calls / MCP).
- **human-facing/** — agentic-ui (surfacing agent work), agentic-ux (human–agent interaction principles).
