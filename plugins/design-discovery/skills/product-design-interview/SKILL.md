...
description: "Socratic, crtr human-led interview to shape the ideal product experience — not technical design. Use when the user has product-design questions, wants to figure out how a product or feature should feel, or says 'grill me' / 'ask me about the product'. Technical counterpart: technical-design-interview."
type: playbook
---
...
- Deck JSON shape, a worked wave, the reflect-back mechanism, and the full lens catalog live in [reference.md](reference.md).
...
Pressure-test with: **pre-mortem** ("they tried it once and never came back — why?"), **the one-sentence pitch** ("how would a user describe this to a friend?"), and **subtraction** ("what could we remove to make it better?"). Full catalog with question phrasings: [reference.md](reference.md).
