...
Inputs: a design file and the matching requirements file (often in the same topic directory).
...
>
> Inputs: the design file and the requirements file.
>
> ## Process
>
> 1. Read requirements — extract every user story and acceptance criterion.
> 2. Read the design.
...
> 3. Read any project conventions docs (e.g. CLAUDE.md, rules files) for established patterns.
> 4. Check:
