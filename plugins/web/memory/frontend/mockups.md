---
kind: knowledge
when-and-why-to-read: When the user wants to visualize a UI concept, compare design options, or prototype a feature before implementing it in the real codebase, this knowledge should be read because testing concepts in a project-faithful interactive artifact exposes UX tradeoffs early and avoids expensive implementation churn.
short-form: Build a self-contained interactive HTML mockup that matches the project's actual theme, for UX exploration and design review before any real code.
---
# Frontend mockups
