...
gate:
  kind:
    imatches: '^(general|design)($|/)'
---

# Web / frontend

- **frontend/design-website** — interactive product-design workflow producing a design document.
- **frontend/role-ui-ux** — UX-consultant role: opinions on flows and IA, no implementation.
